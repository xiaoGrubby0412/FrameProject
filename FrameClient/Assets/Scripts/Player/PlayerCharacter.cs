...
public class PlayerCharacter : MonoBehaviour
{
    ...
    public int roleid
    {
        get { return mPlayerInfo.roleid; }
    }

    public string name
    {
        get { return mPlayerInfo.name; }
    }

    public int type
    {
        get { return mPlayerInfo.type; }
    }

    public int maxBlood
    {
        get { return mPlayerInfo.maxBlood; }
    }

    public int nowBlood
    {
        get { return mPlayerInfo.nowBlood; }
    }

    public int moveSpeed
    {
        get { return (int)mNavMeshAgent.speed * 100; }
    }

    public int moveSpeedAddition
    {
        get { return mPlayerInfo.moveSpeedAddition; }
    } //移速加成

    public int moveSpeedPercent
    {
        get { return mPlayerInfo.moveSpeedPercent; }
    }
    ...
    public void SetSpeed(int moveSpeedAddition, int moveSpeedPercent)
    {
        if (mPlayerInfo != null)
        {
            ...
            mNavMeshAgent.speed = (mPlayerInfo.moveSpeed * (1 + mPlayerInfo.moveSpeedPercent * 0.01f) +
                                   mPlayerInfo.moveSpeedAddition) * 0.01f;
        }
    }
        ...
        switch (skillid)
        {
            ...
            case 2:
            {
                ...
                if (obj)
                {
                    ...
                    {
                        Quaternion q = Quaternion.Euler(r.eulerAngles.x, r.eulerAngles.y - (10 * i) + 45,
                            r.eulerAngles.z); ///求出第i个点的旋转角度
            ...
            case 3:
            {
                ...
                if (obj)
                {
                    ...
                    {
                        Quaternion q = Quaternion.Euler(r.eulerAngles.x, r.eulerAngles.y - (10 * i),
                            r.eulerAngles.z); ///求出第i个点的旋转角度
